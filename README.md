...
-Track key business KPIs such as total sales, average order value, and product performance

-Identify sales trends across time, products, and categories
...
-Analyzed daily, monthly, and category-wise sales trends
...
-Interactive slicers for time, product, and category analysis
...
-Improved ability to convert data into actionable insights

-Gained hands-on experience in dashboard design and data storytelling
